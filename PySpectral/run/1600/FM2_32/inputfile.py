...
def savehook(main,grid,utilities,iteration):
    ...
    np.savez_compressed(string2,uhat=main.uhat,vhat=main.vhat,what=main.what,w0_u=main.w0_u,w0_v=main.w0_v,w0_w=main.w0_w,w1_u=main.w1_u,w1_v=main.w1_v,w1_w=main.w1_w,t=main.t)
